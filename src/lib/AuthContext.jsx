...
export const AuthProvider = ({ children }) => {
   ...
   *
   * Calls the delete-user Edge Function which uses the service-role key to wipe all
   * personal data and permanently remove the auth.users row. A new sign-up with the
   * same email will get a brand-new UUID and can never inherit this account's data.
   * Loans/payments referencing this user's UUID are left intact for the other party.
   */
  const deleteAccount = async () => {
    ...
    try {
      ...
      console.error('deleteAccount edge-function error:', err);
    }
