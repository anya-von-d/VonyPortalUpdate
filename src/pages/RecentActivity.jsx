...
export default function RecentActivityPage() {
  ...
  if (isLoading || !user) {
    return (
      <div style={{ minHeight: '100vh', position: 'relative', fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", fontSize: 14, lineHeight: 1.5, color: '#1A1918', WebkitFontSmoothing: 'antialiased', paddingLeft: 240, paddingTop: 56, background: '#F5F4F0' }}>
