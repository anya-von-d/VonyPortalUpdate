        ...
        <div className="mesh-center" style={{ background: 'transparent', padding: '24px 48px 80px' }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ marginBottom: 8 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '0 12px', background: 'rgba(255,255,255,0.18)', borderRadius: 18, border: '1px solid rgba(0,0,0,0.06)', height: 36 }}>
