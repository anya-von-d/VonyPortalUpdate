...
export default function Home() {
  ...
  return (
    <div className="home-with-sidebar" style={{ minHeight: '100vh', position: 'relative', fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", fontSize: 14, lineHeight: 1.5, color: '#1A1918', WebkitFontSmoothing: 'antialiased', paddingLeft: 240, background: '#F5F4F0' }}>
      ...
      <div className="content-box-glow" style={{ position: 'relative', background: '#6587F9', margin: '8px 12px 12px 12px', borderRadius: 24, minHeight: 'calc(100vh - 80px)', border: '12px solid rgba(255,255,255,0.8)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)', boxShadow: 'rgba(0,0,0,0.03) 0px 0.6px 2.3px -0.42px, rgba(0,0,0,0.04) 0px 2.3px 8.7px -0.83px, rgba(0,0,0,0.08) 0px 10px 38px -1.25px' }}>
                  ...
                  {myLoans.filter(l => l && l.status === 'active').slice(0, 4).map((loan, idx) => {
                    ...
                    return (
                      <div key={loan.id}>
                        ...
                        <div style={{ width: '100%', height: 8, borderRadius: 4, background: isLender ? 'rgba(103,138,251,0.15)' : 'rgba(167,157,234,0.15)', overflow: 'hidden' }}>
                          <div style={{ height: '100%', borderRadius: 4, width: `${pct}%`, background: isLender ? '#678AFB' : '#A79DEA', transition: 'width 1s cubic-bezier(0.4, 0, 0.2, 1)' }} />
                        </div>
