    ...
    return (
      <div style={{ position: 'relative', minHeight: '100vh', background: '#F5F4F0', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none' }}>
          ...
          {/* iMessage — top-left */}
          <motion.div {...floatAnim(0.2, -4)} style={{ position: 'absolute', top: '4%', left: '-1%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.35, 5)} style={{ position: 'absolute', top: '32%', left: '2%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.55, -3)} style={{ position: 'absolute', top: '58%', left: '-2%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.5, -2)} style={{ position: 'absolute', bottom: '2%', left: '-1%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.6, -3)} style={{ position: 'absolute', top: '6%', right: '-1%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.7, 6)} style={{ position: 'absolute', top: '28%', right: '-1%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.65, 2)} style={{ position: 'absolute', top: '72%', right: '-1%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.58, -3)} style={{ position: 'absolute', bottom: '4%', right: '1%', filter: floatShadow }}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{ maxWidth: 400, width: '100%', position: 'relative', zIndex: 2 }}>
          <div className="glass-card" style={{ padding: 36, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: 14, color: '#787776', marginBottom: 28, fontFamily: "'DM Sans', sans-serif" }}>
              Lending with friends made simple.
            </p>
  ...
  return (
    <div style={{ minHeight: '100vh', fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: 14, lineHeight: 1.5, color: '#1A1918', WebkitFontSmoothing: 'antialiased' }}>
      ...
      <div className="mesh-layout" style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 0 }}>
        ...
        {/* ── CENTER ── */}
        <div className="mesh-center" style={{ background: '#ffffff', padding: '24px 48px 80px' }}>
