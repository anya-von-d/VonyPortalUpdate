    ...
    return (
      <div style={{ position: 'relative', minHeight: '100vh', background: '#F5F4F0', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none' }}>
          ...
          {/* iMessage — top-left */}
          <motion.div {...floatAnim(0.2, -4)} style={{ position: 'absolute', top: '14%', left: '-1%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.6, -3)} style={{ position: 'absolute', top: '16%', right: '-1%', filter: floatShadow }}>
          ...
          {/* Calculator — mid-right */}
          <motion.div {...floatAnim(0.7, 6)} style={{ position: 'absolute', top: '34%', right: '1%', filter: floatShadow }}>
          ...
          <motion.div {...floatAnim(0.4, -2)} style={{ position: 'absolute', top: '52%', right: '-1%', filter: floatShadow }}>
          ...
          {/* Post-it yellow — mid-left */}
          <motion.div {...floatAnim(0.35, 5)} style={{ position: 'absolute', top: '42%', left: '2%', filter: floatShadow }}>
          ...
          {/* Excel spreadsheet — bottom-left */}
          <motion.div {...floatAnim(0.55, -3)} style={{ position: 'absolute', bottom: '-2%', left: '-1%', filter: floatShadow }}>
          ...
          {/* Notes app — bottom-center-left */}
          <motion.div {...floatAnim(0.5, -2)} style={{ position: 'absolute', bottom: '-2%', left: '22%', filter: floatShadow }}>
          ...
          {/* Reminder 2 (Saoirse) — bottom-center */}
          <motion.div {...floatAnim(0.65, 2)} style={{ position: 'absolute', bottom: '6%', left: '38%', filter: floatShadow }}>
          ...
          {/* Post-it blue — bottom-right-center */}
          <motion.div {...floatAnim(0.58, -3)} style={{ position: 'absolute', bottom: '3%', right: '20%', filter: floatShadow }}>
          ...
          {/* WhatsApp (Henry) — bottom-right */}
          <motion.div {...floatAnim(0.3, 2)} style={{ position: 'absolute', bottom: '-1%', right: '-1%', filter: floatShadow }}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{ maxWidth: 400, width: '100%', position: 'relative', zIndex: 2 }}>
          <div className="glass-card" style={{ padding: 36, textAlign: 'center' }}>
            <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontStyle: 'italic', fontWeight: 600, fontSize: '2.2rem', color: '#1A1918', letterSpacing: '-0.01em', lineHeight: 1, marginBottom: 10 }}>
              Vony
            </div>
            <h1 style={{ fontSize: '1.4rem', fontWeight: 700, color: '#1A1918', marginBottom: 28, letterSpacing: '-0.02em', fontFamily: "'DM Sans', sans-serif" }}>
              Welcome to Vony
            </h1>
