...
export default function Home() {
  ...
  return (
    <div className="home-with-sidebar" style={{ minHeight: '100vh', position: 'relative', fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", fontSize: 14, lineHeight: 1.5, color: '#1A1918', WebkitFontSmoothing: 'antialiased', paddingLeft: 200, paddingTop: 56, background: '#F5F4F0' }}>

      <DashboardSidebar activePage="Dashboard" user={user} />

      {/* ── Title ── */}
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '16px 28px 8px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, gridRow: '1 / 2' }}>
              ...
              <div className="glass-card" style={{ overflow: 'hidden' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px 0' }}>
                  ...
                  <Link to={createPageUrl("Requests")} style={{ fontSize: 12, fontWeight: 500, color: '#03ACEA', textDecoration: 'none' }}>View</Link>
                </div>
