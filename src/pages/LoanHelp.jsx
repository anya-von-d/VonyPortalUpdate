...
export default function LoanHelp() {
  ...
  const toggleCompare = (key) => {
    setCompared(prev => ({ ...prev, [key]: !prev[key] }));
  };
    ...
    <div className="home-with-sidebar" style={{ minHeight: '100vh', fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif", fontSize: 14, lineHeight: 1.5, color: '#1A1918', WebkitFontSmoothing: 'antialiased', paddingTop: 88, background: 'transparent' }}>
      ...
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 40px', background: 'transparent', position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ margin: '8px 10px 0', height: 168, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', paddingBottom: 24, position: 'relative' }}>
          ...
          <p style={{ fontSize: 13, color: '#787776', margin: '10px 0 0', textAlign: 'center', maxWidth: 560, lineHeight: 1.6, position: 'relative', zIndex: 1 }}>
            Personal loans, student loans, credit cards: it's a lot. Vony Loan Help breaks each option down in plain language, comparing rates, terms, and what you'll actually pay back, so you can decide with confidence.
          </p>
        </div>

        {/* Page content */}
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '20px 0 64px', position: 'relative', zIndex: 1 }}>
              ...
              return (
                <motion.div
                  ...
                  style={{
                    background: 'white',
                    borderRadius: 18,
                    border: isRecommended ? '2px solid #03ACEA' : '1px solid rgba(0,0,0,0.06)',
                    boxShadow: isRecommended
                      ? '0 4px 20px rgba(3,172,234,0.12)'
                ...
                >
                  ...
                  <div style={{ padding: '20px 22px', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ marginBottom: 14 }}>
                      <div style={{ fontSize: 17, fontWeight: 700, color: '#1A1918', marginBottom: 3 }}>
                        {loan.name}
                      </div>
