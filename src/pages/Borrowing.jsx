          ...
          >
            ...
            >
              <div className="sticky top-0 bg-white border-b border-slate-100 p-4 flex justify-between items-center">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: 'rgba(3,172,234,0.1)' }}>
                    <FileText className="w-4 h-4" style={{ color: '#03ACEA' }} />
                  </div>
      ...
      <div style={{ minHeight: '100vh', fontFamily: "'DM Sans', system-ui, sans-serif", background: '#ffffff' }}>
        ...
        <div className="mesh-layout" style={{ display: 'grid', gridTemplateColumns: '180px 1fr 300px', gap: 0, minHeight: '100vh' }}>
          ...
          <div className="mesh-center" style={{ background: 'transparent', borderRight: '1px solid rgba(0,0,0,0.06)', padding: '24px 32px 80px' }}>
            <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", fontSize: 17, fontWeight: 600, color: '#1A1918', letterSpacing: '-0.02em', marginBottom: 32 }}>My Loans</div>
  
          {/* Tab bar — centered */}
          <div className="mobile-tab-bar" style={{ display: 'flex', justifyContent: 'center', marginBottom: 20 }}>
            <div style={{ display: 'inline-flex', gap: 2, background: 'transparent', borderRadius: 10, padding: 3 }}>
          ...
          {activeTab === 'summary' && (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }} className="borrowing-grid">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    {activeLoans.length === 0 ? (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                        {activeLoans.slice(0, 5).map(loan => {
                          ...
                          return (
                            <div key={loan.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 0' }}>
                              <span style={{ fontSize: 12, fontWeight: 500, color: '#1A1918' }}>{lender?.full_name || 'User'}{loan.purpose ? <span style={{ fontSize: 11, color: '#9B9A98', fontWeight: 400 }}> · {loan.purpose}</span> : ''}</span>
                              <span style={{ fontSize: 12, fontWeight: 600, color: '#2563EB', flexShrink: 0, marginLeft: 8 }}>${(loan.amount || 0).toLocaleString()}</span>
                            </div>
                          );
                        })}
                      </div>
                ...
                <div style={{ marginBottom: 8 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: 10, marginBottom: 4, borderBottom: '1px solid rgba(0,0,0,0.07)' }}>
                    <span style={{ fontSize: 9, fontWeight: 700, color: '#9B9A98', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Upcoming</span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        return (
                          <div key={`overdue-${loan.id}`} className="glass-hero-alert" style={{ padding: '14px 20px', display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            <Link to={createPageUrl("RecordPayment")} style={{
                              padding: '7px 18px', borderRadius: 20, background: '#03ACEA', color: 'white',
                ...
                {/* Loans Ranked By */}
                {activeLoans.length > 0 && (
                  <PageCard title="Loans Ranked By" headerRight={<Select value={rankingFilter} onValueChange={setRankingFilter}>
                        <SelectTrigger className="w-auto h-7 px-2 border-0 text-xs font-medium rounded-lg" style={{ background: 'rgba(3,172,234,0.1)', color: '#03ACEA' }}>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                            ...
                            <div style={{ padding: '10px 14px 14px' }}>
                              <div style={{ position: 'relative' }}>
                                <select
                                  ...
                                  style={{ width: '100%', appearance: 'none', borderRadius: 10, padding: '8px 12px', fontSize: 12, fontWeight: 600, color: '#1A1918', background: 'rgba(3,172,234,0.08)', cursor: 'pointer', border: '1px solid rgba(3,172,234,0.2)', outline: 'none', fontFamily: "'DM Sans', sans-serif" }}
                                >
                                ...
                                <div style={{ pointerEvents: 'none', position: 'absolute', top: 0, bottom: 0, right: 10, display: 'flex', alignItems: 'center' }}>
                                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#03ACEA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
                                </div>
                              </div>
                            </div>
                          </PageCard>
                          ...
                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }} className="borrowing-grid">
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                              ...
                              {manageLoanSelected && (() => {
                                ...
                                return (
                                  <PageCard title="Payment Progress">
                                    <div style={{ padding: '4px 14px 12px', display: 'flex', alignItems: 'center', gap: 16 }}>
                                      ...
                                      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
                                        <div style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.45) 0%, rgba(3,172,234,0.06) 60%, rgba(3,172,234,0.10) 100%)', backdropFilter: 'blur(10px) saturate(1.6)', WebkitBackdropFilter: 'blur(10px) saturate(1.6)', border: '2px solid #03ACEA', borderRadius: 12, padding: '10px 12px', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.6), inset 0 0 16px rgba(3,172,234,0.07), 0 0 0 4px rgba(3,172,234,0.15), 0 0 24px rgba(3,172,234,0.18), 0 2px 12px rgba(0,0,0,0.04)' }}>
                                          ...
                                          {daysUntil !== null && nextPmtDate && (
                                            <div style={{ fontSize: 10, color: '#787776', marginTop: 1 }}>
                                              {daysUntil > 0 ? `${daysUntil}d away` : daysUntil === 0 ? 'Due today' : `${Math.abs(daysUntil)}d overdue`}
                                            </div>
                                          )}
                                        </div>
                                        <div style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.45) 0%, rgba(3,172,234,0.06) 60%, rgba(3,172,234,0.10) 100%)', backdropFilter: 'blur(10px) saturate(1.6)', WebkitBackdropFilter: 'blur(10px) saturate(1.6)', border: '2px solid #03ACEA', borderRadius: 12, padding: '10px 12px', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.6), inset 0 0 16px rgba(3,172,234,0.07), 0 0 0 4px rgba(3,172,234,0.15), 0 0 24px rgba(3,172,234,0.18), 0 2px 12px rgba(0,0,0,0.04)' }}>
                              ...
                              {manageLoanSelected && manageLoanSelected.status !== 'cancelled' && (
                                <div style={{ justifyContent: 'center', gap: 20, padding: '4px 0' }}>
                                  <button onClick={() => handleEditLoan(manageLoanSelected)} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', background: 'none', border: 'none' }}>
                                    <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(3,172,234,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#03ACEA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                                    </div>
                                  ...
                                  <button onClick={() => handleCancelLoan(manageLoanSelected)} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', background: 'none', border: 'none' }}>
                                    <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(3,172,234,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#03ACEA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>
                                    </div>
                                ...
                                {!manageLoanSelected ? (
                                  ...
                                  <div style={{ position: 'relative' }}>
                                    <div style={{ display: 'flex', alignItems: 'flex-end', gap: 2, height: chartHeight }}>
                                      ...
                                      <div style={{ flex: 1, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', position: 'relative', height: '100%' }}>
                                        {plannedPaymentAmount > 0 && (
                                          <div style={{ position: 'absolute', left: 0, right: 0, borderTop: '2px dashed rgba(3,172,234,0.3)', zIndex: 10, bottom: `${(plannedPaymentAmount / maxChartVal) * 100}%` }}>
                                        ...
                                        {chartData.map((d, i) => {
                                          ...
                                          return (
                                            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
                                              <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                                                {isInProgress && !isFullPmt ? (
                                                  <div style={{ position: 'relative', height: Math.max(scheduledBarHeight, 4), width: 14 }}>
                                                    <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '100%', borderRadius: '4px 4px 0 0', background: 'rgba(3,172,234,0.1)', border: '1px dashed rgba(3,172,234,0.3)' }} />
                                                    <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: Math.max(barHeight, 4), borderRadius: '4px 4px 0 0', background: 'rgba(3,172,234,0.6)' }} />
                                                  </div>
                                                ) : (
                                                  <div style={{
                                                    borderRadius: '4px 4px 0 0', transition: 'all 0.3s',
                                                    height: Math.max(barHeight, d.amount > 0 ? 4 : 2), width: 14,
                                                    background: d.isProjected ? 'rgba(3,172,234,0.15)' : d.isMissed ? 'rgba(232,114,110,0.3)' : d.amount === 0 ? '#E5E4E2' : isPendingOnly ? 'rgba(245,158,11,0.4)' : isFullPmt ? '#03ACEA' : isPartialPmt ? 'rgba(245,158,11,0.6)' : 'rgba(3,172,234,0.6)',
                                                    border: d.isProjected ? '1px dashed rgba(3,172,234,0.3)' : d.isMissed ? '1px dashed rgba(232,114,110,0.5)' : isPendingOnly ? '1px dashed rgba(245,158,11,0.6)' : 'none',
                                                  }}
                                              ...
                                              <p style={{ fontSize: 10, marginTop: 4, lineHeight: 1, margin: 0, color: isInProgress ? '#03ACEA' : d.isProjected ? '#C7C6C4' : d.isMissed ? '#E8726E' : isPendingOnly ? 'rgba(245,158,11,0.6)' : '#787776' }}>{d.label}</p>
                                            </div>
                                          );
                                        })}
                                      </div>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 8, paddingTop: 8, borderTop: '1px solid rgba(0,0,0,0.06)', flexWrap: 'wrap' }}>
                                      ...
                                      <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}><div style={{ width: 10, height: 10, borderRadius: 2, background: 'linear-gradient(to top, rgba(3,172,234,0.6) 50%, rgba(3,172,234,0.1) 50%)' }} /><span style={{ fontSize: 9, color: '#03ACEA' }}>In Progress</span></div>
                                      ...
                                      <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}><div style={{ width: 10, height: 10, borderRadius: 2, background: 'rgba(3,172,234,0.15)', border: '1px dashed rgba(3,172,234,0.3)' }} /><span style={{ fontSize: 9, color: '#C7C6C4' }}>Projected</span></div>
                                      <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}><div style={{ width: 16, height: 0, borderTop: '2px dashed rgba(3,172,234,0.3)' }} /><span style={{ fontSize: 9, color: '#787776' }}>Plan</span></div>
                                    </div>
                                  </div>
                                )}
                                </div>
                                ...
                                <>
                                  ...
                                  <div style={{ justifyContent: 'center', gap: 20, padding: '4px 0' }}>
                                    <button onClick={() => { const agreement = loanAgreements.find(a => a.loan_id === manageLoanSelected.id); if (agreement) openDocPopup('promissory', agreement); }} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', background: 'none', border: 'none' }}>
                                      <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(3,172,234,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#03ACEA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
                                      </div>
                                    ...
                                    <button onClick={() => { const agreement = loanAgreements.find(a => a.loan_id === manageLoanSelected.id); if (agreement) openDocPopup('amortization', agreement); }} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', background: 'none', border: 'none' }}>
                                      <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(3,172,234,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#03ACEA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                      </div>
                                    ...
                                    <button onClick={() => { const agreement = loanAgreements.find(a => a.loan_id === manageLoanSelected.id); if (agreement) openDocPopup('summary', agreement); }} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, cursor: 'pointer', background: 'none', border: 'none' }}>
                                      <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'rgba(3,172,234,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#03ACEA" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                                      </div>
                                  ...
                                  <PageCard title="Payments">
                                    ...
                                    {(() => {
                                      ...
                                      const paymentRows = loanAnalysis ? loanAnalysis.periodResults.map((pr) => {
                                        ...
                                        else if (!firstRecordFound) { status = 'upcoming'; firstRecordFound = true; }
                                      ...
                                      const statusConfig = {
                                        ...
                                        record: { label: 'Record Payment', bg: '#03ACEA', text: 'white', ringColor: '#03ACEA', fillColor: '#03ACEA' },
                                        upcoming: { label: 'Upcoming', bg: 'rgba(0,0,0,0.03)', text: '#787776', ringColor: 'rgba(3,172,234,0.3)', fillColor: 'rgba(3,172,234,0.3)' },
                                      };
                                      const PieCircle = ({ percentage, ringColor, fillColor, number, size = 32 }) => {
                                        ...
                                        return (
                                          <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} style={{ flexShrink: 0 }}>
                                            <circle cx={pcx} cy={pcy} r={r} fill="#ffffff" stroke={ringColor} strokeWidth="2" strokeOpacity="0.3" />
                                  ...
                                  {/* Activity Box */}
                                  <PageCard title="Activity" style={{ overflow: 'hidden' }}>
                                    <div style={{ padding: '10px 14px 14px' }}>
                                    {(() => {
                                      const agreement = loanAgreements.find(a => a.loan_id === manageLoanSelected.id);
                                      ...
                                      const getIcon = (type) => {
                                        const strokeColor = type === 'cancellation' ? '#E8726E' : '#03ACEA';
                                        switch (type) {
                                          case 'created':
                                            return (
                                      ...
                                      const getDotColor = (type) => {
                                        switch (type) {
                                          ...
                                          default: return 'bg-blue-50 border-[#03ACEA]';
                                        }
                                      };
                                          ...
                                          {activities.map((activity, idx) => (
                                            <div key={idx} className="flex items-start gap-2.5 relative">
                                              ...
                                              {idx < activities.length - 1 && (
                                                <div className="absolute left-[11px] top-[22px] w-[1px]" style={{ height: 'calc(100% - 6px)', background: 'rgba(3,172,234,0.2)' }} />
                                              )}
                                              {/* Icon dot */}
      ...
      <AlertDialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
        <AlertDialogContent className="rounded-2xl border-0 p-0 overflow-hidden" style={{ backgroundColor: '#fafafa' }}>
          ...
          <div className="px-6 pb-6 flex flex-col sm:flex-row gap-3">
            <AlertDialogCancel className="flex-1 rounded-xl border-0 font-semibold text-white text-[14px] h-12 hover:opacity-90 transition-all" style={{ backgroundColor: '#03ACEA' }}>
              Keep Loan
            </AlertDialogCancel>
