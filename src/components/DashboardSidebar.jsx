    ...
    <>
      ...
      {(() => {
        const icons = [
          ...
          { color: '#7C3AED', label: 'Create loan',    page: 'CreateOffer',    svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg> },
          { color: '#16A34A', label: 'Record payment', page: 'RecordPayment',  svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> },
          ...
          { color: '#7C3AED', label: 'Activity',       page: 'RecentActivity', svg: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg> },
        ...
        // Deterministic varied rotations per row (readable but not identical)
        const leftRots  = [-13, -9, -15, -8, -14, -10, -16, -11];
        const rightRots = [ 11, 15,   9, 14,  10,  16,   8,  13];
        const spacing = 120;
        const startY = 140;
